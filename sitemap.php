    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 md-mb-30px">
                <img src="https://placehold.co/800x600/png?text=Sitemap+Visual" class="border-radius-10px box-shadow-quadruple-large-hover h-100 transition-inner-all" alt="Sitemap">
            </div>
