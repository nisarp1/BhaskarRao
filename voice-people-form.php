    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-xl-7 col-lg-8 position-relative z-index-2" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <p class="fs-20 text-white opacity-8 mb-0 w-80 lg-w-100 fw-300">A better Bengaluru is not built by systems alone, but by responsible citizens and accountable governance working together. Join me for a Greater Chamrajpet.</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <form action="#" method="post" class="row contact-form-style-02">
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-medium btn-rounded with-rounded bg-gradient-saffron text-white border-0 btn-box-shadow w-100" type="submit">Submit Voice<span class="bg-white text-saffron"><i class="feather icon-feather-arrow-right"></i></span></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                ...
                <p class="fs-18">As part of his commitment to transparency, Shri Bhaskar Rao holds standard "Janatha Samparka" (People's Meetings). Dates and locations for the upcoming weekly meetings are posted here.</p>
            </div>
        </div>
    </div>
</section>
