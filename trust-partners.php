    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-xl-7 col-lg-8 position-relative z-index-2" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <h1 class="text-white alt-font fw-700 ls-minus-2px mb-25px" style="font-size: 3.5rem; line-height: 3.7rem;">Partners & Alliance</h1>
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center mt-5">
            ...
            <div class="col md-mb-30px">
                <div class="bg-white p-5 border-radius-10px box-shadow-quadruple-large-hover h-100 transition-inner-all border-bottom border-4 border-color-brand-saffron">
                    ...
                    <p>Detailed exploration of the primary goals and objectives associated with Partners & Alliance. We aim for excellence in every endeavor.</p>
                </div>
            </div>
            <!-- Feature 2 -->
            <div class="col md-mb-30px">
                <div class="bg-white p-5 border-radius-10px box-shadow-quadruple-large-hover h-100 transition-inner-all border-bottom border-4 border-color-brand-green">
                    ...
                    <p>Focusing on how Partners & Alliance interacts with and empowers the local communities and stakeholders.</p>
                </div>
            </div>
            <!-- Feature 3 -->
            <div class="col">
                <div class="bg-white p-5 border-radius-10px box-shadow-quadruple-large-hover h-100 transition-inner-all border-bottom border-4 border-color-brand-saffron">
                    ...
                    <p>Ensuring that the outcomes of our work in Partners & Alliance are long-lasting and continue to benefit society for years to come.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 md-mb-30px">
                <img src="https://placehold.co/800x600/png?text=Partners & Alliance+Visual" class="border-radius-10px box-shadow-quadruple-large-hover h-100 transition-inner-all" alt="Partners & Alliance">
            </div>
            <div class="col-lg-5 offset-lg-1">
                <h4 class="alt-font text-dark-gray fw-600">Why it matters?</h4>
                <p class="fs-17">Public service requires a deep understanding of the challenges faced by citizens. Through Partners & Alliance, we address these challenges head-on with innovative solutions and a human-centric approach.</p>
