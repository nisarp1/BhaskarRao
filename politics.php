    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-xl-7 col-lg-8 position-relative z-index-2" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <h1 class="text-white alt-font fw-700 ls-minus-2px mb-25px" style="font-size: 3.5rem; line-height: 3.7rem;">Political Vision</h1>
                <p class="fs-20 text-white opacity-8 mb-0 w-80 lg-w-100 fw-300">Transitioning from administrative leadership to active political service to build a smarter, safer Karnataka.</p>
            ...
            <div class="col-xl-5 col-lg-4 d-none d-lg-block position-relative z-index-2 text-end" style="padding-top: 80px;">
                <div class="d-inline-block position-relative">
                    <img src="images/new/banners/politics.jpg" class="border-radius-15px box-shadow-quadruple-large border border-4 border-white" style="max-height: 400px; object-fit: cover;" alt="Banner">
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center">
            ...
            <div class="col md-mb-30px" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="premium-value-card text-center h-100">
                    <i class="bi bi-bank value-icon"></i>
                    <h5 class="alt-font text-dark-gray fw-700 mb-15px">National Integrity</h5>
                    <p class="mb-0">A firm believer that only strong, principled leadership can protect the country's sovereignty.</p>
                </div>
            </div>
            <!-- Feature 2 -->
            <div class="col md-mb-30px" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="premium-value-card text-center h-100">
                    ...
                    <h5 class="alt-font text-dark-gray fw-700 mb-15px">Grassroots Development</h5>
                    <p class="mb-0">Focused on de-polarizing local issues and addressing the "rampant poverty" that often leads to social challenges.</p>
                </div>
            </div>
            <!-- Feature 3 -->
            <div class="col" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 400, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="premium-value-card text-center h-100">
                    <i class="bi bi-chat-heart-fill value-icon"></i>
                    <h5 class="alt-font text-dark-gray fw-700 mb-15px">Youth Empowerment</h5>
                    <p class="mb-0">Advocating for skill-based training and government job transparency to provide the next generation with real opportunities.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 md-mb-30px">
                <img src="images/new/with-bjp.jpg" class="border-radius-6px box-shadow-quadruple-large" alt="Political Vision">
            </div>
            <div class="col-lg-5 offset-lg-1">
                ...
                <a href="contact.php" class="btn btn-large btn-rounded with-rounded bg-gradient-saffron text-white border-0 btn-box-shadow mt-30px">Connect with us<span class="bg-white text-saffron"><i class="feather icon-feather-arrow-right"></i></span></a>
                <a href="javascript:void(0);" class="btn btn-large btn-rounded with-rounded btn-transparent-white-light text-saffron btn-box-shadow mt-30px ms-4" data-bs-toggle="modal" data-bs-target="#videoModal" data-video-id="T912dduUqxw">Watch Video<span class="bg-gradient-saffron text-white" style="-webkit-text-fill-color: white !important; color: white !important;"><i class="bi bi-play-fill fs-18 mt-minus-2px"></i></span></a>
            </div>
        </div>
    </div>
</section>
