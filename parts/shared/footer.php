    <!-- start footer -->
    <footer class="bg-gradient-blue-ironstone-brown p-0">
            ...
            <div class="row pt-50px pb-50px md-pt-35px md-pb-35px">
                ...
                <div class="col-lg-3 col-sm-6 text-center text-lg-start last-paragraph-no-margin md-mb-40px sm-mb-30px">
                    <a href="index.php" class="footer-logo d-inline-block mb-15px">
                        <span class="fs-22 fw-700 alt-font text-base-color">Bhaskar Rao IPS <span class="fs-12 text-white text-uppercase ls-0px fw-500">(Retd.)</span></span>
                    </a>
                    ...
                    <div class="elements-social social-icon-style-02 mt-20px xs-mt-15px">
                        <ul class="small-icon icon-with-animation">
                            <li class="my-0"><a class="facebook" href="https://www.facebook.com/IPSBhaskarRao/" target="_blank"><i class="fa-brands fa-facebook-f text-white"></i></a></li>
                            <li class="my-0"><a class="twitter" href="https://x.com/Nimmabhaskar22" target="_blank"><i class="fa-brands fa-x-twitter text-white"></i></a></li>
                            <li class="my-0"><a class="instagram" href="https://www.instagram.com/bhaskarrao/?hl=en" target="_blank"><i class="fa-brands fa-instagram text-white"></i></a></li>
                        </ul>
                    </div>
                </div>
                <!-- end footer column -->
                ...
                <div class="col-lg-3 col-sm-6 text-center text-lg-start last-paragraph-no-margin md-mb-40px sm-mb-30px">
                    ...
                    <ul class="p-0 m-0 list-style-01 text-white opacity-7">
                        <li class="mb-5px"><a href="about-introduction.php" class="text-white hover-text-base-color">About Me</a></li>
                        <li class="mb-5px"><a href="ips-career.php" class="text-white hover-text-base-color">IPS Career</a></li>
                        <li class="mb-5px"><a href="politics.php" class="text-white hover-text-base-color">Politics</a></li>
                        <li class="mb-5px"><a href="red-cross.php" class="text-white hover-text-base-color">Red Cross</a></li>
                    </ul>
                </div>
                <!-- end footer column -->
                <!-- start footer column -->
                ...
                <div class="col-lg-3 col-sm-6 text-center text-lg-start last-paragraph-no-margin">
                    ...
                    <p class="text-white opacity-7 fs-15 mb-10px">Indian Red Cross Society,<br>Karnataka State Branch.</p>
                    <p class="mb-5px"><a href="tel:+919845352310" class="text-white opacity-7 hover-text-base-color">+91 98453 52310</a></p>
                    <a href="mailto:contact@bhaskarrao.in" class="text-white text-decoration-line-bottom opacity-7 hover-text-base-color fs-15">contact@bhaskarrao.in</a>
                </div>
                <!-- end footer column -->
            </div>
        </div>
