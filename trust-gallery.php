    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-xl-7 col-lg-8 position-relative z-index-2" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <h1 class="text-white alt-font fw-700 ls-minus-2px mb-25px" style="font-size: 3.5rem; line-height: 3.7rem;">Trust Gallery</h1>
        ...
        <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center">
            ...
            <div class="col md-mb-30px" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="premium-value-card text-center h-100">
                    ...
                    <p class="mb-0">Detailed exploration of the primary goals and objectives associated with Trust Gallery. We aim for excellence in every endeavor.</p>
                </div>
            </div>
            <!-- Feature 2 -->
            <div class="col md-mb-30px" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="premium-value-card text-center h-100">
                    ...
                    <p class="mb-0">Focusing on how Trust Gallery interacts with and empowers the local communities and stakeholders.</p>
                </div>
            </div>
            <!-- Feature 3 -->
            <div class="col" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 400, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="premium-value-card text-center h-100">
                    ...
                    <p class="mb-0">Ensuring that the outcomes of our work in Trust Gallery are long-lasting and continue to benefit society for years to come.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 offset-lg-1">
                ...
                <p class="fs-17">Public service requires a deep understanding of the challenges faced by citizens. Through Trust Gallery, we address these challenges head-on with innovative solutions and a human-centric approach.</p>
