    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-xl-7 col-lg-8 position-relative z-index-2" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <h1 class="text-white alt-font fw-700 ls-minus-2px mb-25px" style="font-size: 3.5rem; line-height: 3.7rem;">Chamarajpet</h1>
                <p class="fs-20 text-white opacity-8 mb-0 w-80 lg-w-100 fw-300">Dedicated to transforming Chamarajpet into a model constituency through sustainable development and citizen safety.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 md-mb-30px">
                <img src="images/new/services/2.jpg" class="border-radius-6px box-shadow-quadruple-large" alt="Chamarajpet Development">
            </div>
            <div class="col-lg-5 offset-lg-1">
                <h4 class="alt-font text-dark-gray fw-600">The Seven Wards of Chamarajpet</h4>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 order-lg-2">
                <img src="images/new/news/2.jpg" class="border-radius-10px box-shadow-quadruple-large w-100" alt="Vision">
            </div>
            <div class="col-lg-6 px-lg-5 md-mt-40px order-lg-1">
                ...
                <div class="d-flex mb-4">
                    ...
                    <div>
                        ...
                        <p>Fostering a spirit of "Sabka Saath, Sabka Vikas" within the multilingual and multi-religious fabric of Chamarajpet.</p>
                    </div>
                </div>
                <div class="d-flex">
                    <div class="feature-box-icon me-20px">
