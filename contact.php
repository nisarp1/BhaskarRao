            ...
            <div class="col-lg-7">
                <form action="#" method="post" class="row contact-form-style-02">
                    <div class="col-md-6 mb-30px">
                        <input class="input-name border-radius-4px border-color-extra-medium-gray bg-white form-control required" type="text" name="name" placeholder="Full Name*">
                    </div>
                    <div class="col-md-6 mb-30px">
                        <input class="input-email border-radius-4px border-color-extra-medium-gray bg-white form-control required" type="email" name="email" placeholder="Email Address*">
                    </div>
                    <div class="col-md-12 mb-30px">
                        <input class="form-control border-radius-4px border-color-extra-medium-gray bg-white" type="text" name="subject" placeholder="Subject">
                    </div>
                    <div class="col-md-12 mb-30px">
